// Hallmark · component: hierarchical completed list v7 · genre: modern-minimal · theme: DMS dynamic
    ...
    Item {
        ...
        ListView {
            ...
            delegate: Item {
                ...
                readonly property int hierarchyDepth: section.pluginRoot.depthWithinTasks(taskId, section.visibleTasks)
                ...
                Row {
                    ...
                    anchors.top: parent.top
                    height: 48
                    anchors.leftMargin: Theme.spacingXS + completedRow.hierarchyDepth * 18
